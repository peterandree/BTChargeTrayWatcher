...
> This feature (charging indicator, High-alert suppression while charging) shipped. Preserved for historical reference only; check current source for the shipped implementation details.
